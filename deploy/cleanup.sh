#!/usr/bin/env bash
# Ticket 035: limpieza de imágenes/recursos Docker tras cada deploy, en la
...
# de repositorio ("galgoth-studio-dev"/"galgoth-studio-qa"/"galgoth-studio-prod")
