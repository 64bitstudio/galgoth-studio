/**
 * Setup global de Vitest (post-074) -- jsdom no implementa `ResizeObserver`
 ...
 * TextureCanvas.vue, GenerationPreviewViewport.vue, y todo lo que los
 * envuelve -- MobEditor.vue, AiMobWizard.vue, GenerationStep.vue,
 * ResultStep.vue) lanza `ReferenceError: ResizeObserver is not defined`.
 *
 ...
 * vez), este afecta a todo lo que toca el viewport 3D compartido.
 *
