 ...
 * (ticket 018). Los modos Move/Scale/Rotate controlan el gizmo 3D
 * (`TransformControls`, en `ThreeViewportService`) sobre el cuboid
 * seleccionado -- "Select" es el estado por defecto (el click para
 * seleccionar siempre funciona, sin importar el modo activo).
 */
import { ref } from 'vue'
