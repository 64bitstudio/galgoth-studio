...
function project(overrides: Partial<ProjectSummary> = {}): ProjectSummary {
  return { id: 'p1', name: 'Galgoth', description: null, mobCount: 0, mobThumbnails: [], status: 'draft', visibility: 'PRIVATE', ownerDisplayName: null, avatarUrl: null, createdAt: '', updatedAt: new Date().toISOString(), ...overrides }
}
