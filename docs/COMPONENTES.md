...
- **`ProjectDetailPlaceholder.vue`** (ruta `/projects/:id`): deliberadamente mínimo -- solo nombre + conteo de mobs, para que la redirección de HU-01 AC #1 tenga un recurso real. El grid completo de mobs, búsqueda y estado por mob es HU-04 (ticket 022), que reemplaza este componente.
