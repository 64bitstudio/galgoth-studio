...
**Sin hallazgos pendientes** de este ticket al momento de escribir esta sección -- verificación visual en vivo contra `studio-dev` pendiente de completarse como parte del cierre (ver checklist de `cerrar-ticket`), una vez este PR esté mergeado y desplegado.
